        ...
        <div className="flex justify-center items-center  mx-auto  gap-2 h-full pb-10">
          <div className="flex justify-between items-center w-full">
            <div className="flex justify-center items-center flex-col">
              <img src={PromoterIcon} alt="Promoter" className="w-[40px]" />
            ...
            <div className="text-5xl">(</div>
            <div className="flex justify-center items-center flex-col">
              <img src={PassiveIcon} alt="Promoter" className="w-[40px]" />
              <div className="opacity-70 text-[10px] sm:text-xs xl:text-sm">
                Passives %
              </div>
            </div>
            ...
            <div className="flex justify-center items-center flex-col">
              <img src={DetractorIcon} alt="Promoter" className="w-[40px]" />
              <div className="opacity-70 text-[10px] sm:text-xs xl:text-sm">
                Detractors %
              </div>
            </div>
