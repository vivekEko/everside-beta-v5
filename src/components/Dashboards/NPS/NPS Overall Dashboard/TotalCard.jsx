...
const TotalCard = () => {
  ...
  return (
    <div className=" w-full xl:w-[33%]  xl:pl-5 2xl:pl-0   transition-all  flex  justify-center items-center max-w-[320px] sm:max-w-none ">
      {!apiData && (
      ...
      {apiData && (
        <div className="grid  grid-cols-3 xs:grid-cols-2 sm:grid-cols-6   xl:grid-cols-3  justify-between  w-full h-full place-items-center items-center gap-3 md:gap-5 xs:gap-y-7">
